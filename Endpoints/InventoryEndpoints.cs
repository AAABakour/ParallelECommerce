...
public static class InventoryEndpoints
{
    public static void MapInventoryEndpoints(this WebApplication app)
    {
        ...
        app.MapPost("/inventory/reset", (PurchaseRequest request, InventoryService inventoryService) =>
        {
        ...
        app.MapPost("/purchase/after", (PurchaseRequest request, InventoryService inventoryService) =>
        {
        ...
        app.MapPost("/demo/race/after", async (InventoryService inventoryService) =>
        {
            const int productId = 1;
            const int initialStock = 10;
            const int concurrentUsers = 20;
            ...
            var tasks = Enumerable.Range(1, concurrentUsers)
                .Select(_ => Task.Run(() => inventoryService.PurchaseAfter(productId, 1)))
                .ToList();
